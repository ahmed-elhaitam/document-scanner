...
if uploaded_file is not None:
    ...
    st.image(image, use_column_width=True, clamp=True, caption="Image originale")
    ...
    st.image(adaptive_threshold, use_column_width=True, clamp=True, caption="Image segmentée")
